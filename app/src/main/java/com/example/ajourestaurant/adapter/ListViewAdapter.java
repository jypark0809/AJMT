...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.drawer_imageView) ;
        TextView titleTextView = (TextView) convertView.findViewById(R.id.drawer_textView) ;
